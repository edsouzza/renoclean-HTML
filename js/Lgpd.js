...
let lgpdHtml = `
    <div class="cookie-container " id="cookieContainer">
        <div class="areaMsg">
            <p>Nós usamos cookies para garantir a melhor experiência em nosso site. Ao continuar navegando, você concorda com a nossa <a href="/assets/pdf/Politica-de-Cookies.pdf" target="_blank" rel="noreferrer noopener">Política de Cookies</a>.</p>            
        </div>
        <div class="areaBotaoCookie">
            <button class="btnBlue botao btnAceitarCookies"><i class="bi bi-check-lg iconHome"></i>Aceitar</button>                                        
        </div>
    </div>
